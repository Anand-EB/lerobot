...
class FlowConditionalUnet1d(nn.Module):
    ...
    Note: this removes local conditioning as compared to the original Flow policy code.
    """
    ...
    def __init__(self, config: FlowConfig, global_cond_dim: int):
        ...
        # Encoder for the Flow timestep.
        self.diffusion_step_encoder = nn.Sequential(
            FlowSinusoidalPosEmb(config.diffusion_step_embed_dim),
