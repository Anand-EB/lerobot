...
class DiTFlowPolicy(PreTrainedPolicy):
    """Flow Matching Policy with a Diffusion Transformer (DiT) velocity network."""

    config_class = DiTFlowConfig
    name = "ditflow"

    def __init__(self, config: DiTFlowConfig, **kwargs):
    ...
    def predict_action_chunk(self, batch: dict[str, torch.Tensor]) -> torch.Tensor:
        ...
        return self.dit_flow.generate_actions(batch)
